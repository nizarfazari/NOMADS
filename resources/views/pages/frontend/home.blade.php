...
<header class="text-center">
    ...
    <a href="#popular" class="btn btn-cta px-5 my-4">Get started</a>
</header>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 text-center">
                    <img src="{{ url('frontend/images/logos_partner@2x.png') }}" alt="Logo img partner"
                        class="img-partner">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <a href="{{ route('register') }}" class="btn btn-get px-4 mt-4 mx-1">Get Started</a>
                </div>
            </div>
        </div>
    </section>
